...
- Use the **"Simulate Normal / Simulate Anomaly"** toggle switch to select the type of data you want to test.
- Click **"Fill Sample Data"** to automatically populate the 20 Server Resource fields with a randomized test profile matching your selection. Watch for the green flash for normal data, and the red flash for anomalies!
